...
import { Camera, Check, Sparkles, Save, X, Trash2 } from 'lucide-react';
                    ...
                    <CardContent className="space-y-6">
                        <div className="grid gap-6 md:grid-cols-[200px_1fr]">
                            ...
                            <div className="flex flex-col items-center gap-3">
                                <div
                                    className="group relative flex h-32 w-32 cursor-pointer items-center justify-center overflow-hidden rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 transition-all hover:border-slate-400 hover:bg-slate-100"
                                ...
                                {(logoPreview || settings.clinic_logo) && !removeLogo && (
                                    <Button type="button" variant="ghost" size="sm" className="text-red-500 hover:text-red-700" onClick={handleRemoveLogo}>
